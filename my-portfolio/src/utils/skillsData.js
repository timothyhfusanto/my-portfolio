...
export const techStackFrontendFramework = [
  ...
  { name: "Chakra UI", logo: chakrauiImg },
...
export const techStackAnalytics = [
...
export const productSkills = [
  { name: "Requirement Analysis" }, { name: "Product Development Planning" }, { name: "Feature Prioritization" },
  { name: "Use Case Modeling" }, { name: "UML Design" }, { name: "System Architecture" },
  { name: "Market Research & Analysis" }, { name: "Financial Forecasting" }, { name: "Wireframes & UI/UX Design" },
